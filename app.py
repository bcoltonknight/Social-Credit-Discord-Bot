...
admins = [273131410494062593, 325061535162564609, 319796579538173953, 341419086321942530, 492411292179759126, 270424018736250880, 271850427602042880]
# we need to limit the guilds for testing purposes
# so other users wouldn't see the command that we're testing
ids = [763897284730814524, 961864858813468752]
